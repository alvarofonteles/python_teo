...
# tamanho da lista, apenas para listas numéricas
...
# %%
estudo = ['Maria', 28, False, 1.65, 'Arquiteta', 7200.50,
          ['Cadeira', 'Mesa', 'Computador', 'Livro',
              'Caneta', ['Azul', 'Vermelho', 'Verde']],
          ['Maçã', 'Banana', 'Laranja', 'Uva']]
...
estudo = ['Maria', 28, False, 1.65, 'Arquiteta', 7200.50,
          # 7 elementos e 3 listas
          ['Cadeira', 'Mesa', 'Computador', 'Livro', 'Caneta', ['Azul', 'Vermelho', 'Verde'], ['Maçã', 'Banana', 'Laranja', 'Uva']]]
