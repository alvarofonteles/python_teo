...
# %%
nova_lista = ['Alvaro', 42, True, 1.70, 'Eng. Dados', 8500.99,
              ['PySpark', 'Delta Lake', ['Batch', 'Streaming', [
                  'Bronze', 'Silver', 'Gold', 'Data Lake'], 'Databricks']],
              ['PL/SQL', 'Delphi', 'Forms', 'APEX']]
...
# do 1 ao penúltimo - 5 elementos
print(f'nova_lista[1:-1] {nova_lista[1:-1]}')
# do antepenúltimo ao penúltimo - 2 elementos
print(f'nova_lista[-3:-1] {nova_lista[-3:-1]}')
# do antepenúltimo até o final - 3 elementos
print(f'nova_lista[-3:] {nova_lista[-3:]}')
# do início até o antepenúltimo - 4 elementos
print(f'nova_lista[:-3] {nova_lista[:-3]}')
# do início ao final, pulando de 2 em 2 - 4 elementos
print(f'nova_lista[::2] {nova_lista[::2]}')
# do 1 ao final, pulando de 2 em 2 - 3 elementos
print(f'nova_lista[1::2] {nova_lista[1::2]}')
# do final ao início, invertendo a lista - 7 elementos
print(f'nova_lista[::-1] {nova_lista[::-1]}')
# do final ao início, invertendo a lista - 7 elementos
print(f'nova_lista[-1::-1] {nova_lista[-1::-1]}')
# do final ao 1, invertendo a lista - 6 elementos
print(f'nova_lista[-1:0:-1] {nova_lista[-1:0:-1]}')
# do final ao 2, invertendo a lista - 5 elementos
print(f'nova_lista[-1:1:-1] {nova_lista[-1:1:-1]}')
# do final ao 3, invertendo a lista - 4 elementos
print(f'nova_lista[-1:2:-1] {nova_lista[-1:2:-1]}')
